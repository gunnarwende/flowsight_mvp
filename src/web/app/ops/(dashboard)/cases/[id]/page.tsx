    ...
    <>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
        ...
        <div className="space-y-6">
          {/* Contact card */}
          <section className="bg-white border border-gray-200 rounded-xl p-5">
            <h2 className="text-base font-semibold text-gray-900 mb-4">Kontakt</h2>
            <div className="space-y-3">
              ...
              <div className="flex items-start gap-3">
                ...
                <span className="text-sm text-gray-900">
                  {caseData.reporter_name ?? <span className="text-gray-400">Kein Name</span>}
                </span>
              </div>
              ...
              <div className="flex items-start gap-3">
                ...
                <div>
                  ...
                  <a
                    ...
                    className="inline-flex items-center gap-1 text-xs text-amber-600 hover:text-amber-700 hover:underline mt-1"
                  >
          ...
          {/* Notes card (sticky-note style) */}
          {caseData.internal_notes && (
            <section className="bg-amber-50 border border-amber-200 rounded-xl p-5">
              <h2 className="text-base font-semibold text-amber-900 mb-2">Notizen</h2>
