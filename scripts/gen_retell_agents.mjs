...
const globalPrompt = [
  ...
  "- Vollst\u00e4ndiger Sprachwechsel: Wenn der Anrufer auf Englisch oder Franz\u00f6sisch spricht, wechsle KOMPLETT in diese Sprache.",
  "- STICKY: Sobald du gewechselt hast, BLEIBE in dieser Sprache f\u00fcr ALLE weiteren Turns \u2014 R\u00fcckfragen, Zusammenfassung, Abschluss, \u201eIch bin noch da\u201c. Wechsle NIE zur\u00fcck zu Deutsch, es sei denn der Anrufer wechselt selbst.",
  "- Die Post-Call-Analyse (plz, city, category, urgency, description) bleibt IMMER auf Deutsch \u2014 unabh\u00e4ngig von der Gespr\u00e4chssprache.",
  "",
  "THEMA",
...
const intakePrompt = [
  ...
  "4. Frage nach der Postleitzahl: \u201eWie lautet die Postleitzahl des Einsatzortes?\u201c Best\u00e4tige die Ziffern einzeln zur\u00fcck (z.B. \u201eacht, null, null, eins \u2014 korrekt?\u201c).",
  "5. Frage separat nach dem Ort: \u201eUnd der Ort?\u201c Falls unklar: \u201eMeinen Sie Z\u00fcrich oder Zollikon?\u201c",
  ...
  "",
  "SPRACHE (STICKY)",
  "- Wenn der Anrufer Englisch oder Franz\u00f6sisch spricht: wechsle SOFORT und BLEIBE in dieser Sprache f\u00fcr alle weiteren Turns.",
  "- Auch bei Stille, R\u00fcckfragen oder \u201eIch bin noch da\u201c: IMMER in der aktiven Sprache bleiben.",
      ...
      nodes: [
        ...
        },
        {
          instruction: {
            type: "prompt",
            text:
              "Sage dem Anrufer IN DER AKTIVEN GESPR\u00c4CHSSPRACHE sinngem\u00e4\u00df: " +
              p.closing_text +
              " Wenn das Gespr\u00e4ch auf Englisch oder Franz\u00f6sisch gef\u00fchrt wurde, \u00fcbersetze sinngem\u00e4\u00df. Keine erneute Zusammenfassung \u2014 nur der Abschluss.",
          },
          name: "Closing Node",
          edges: [],
          id: "node-closing",
        ...
        },
        {
          instruction: {
            type: "prompt",
            text: "Sage dem Anrufer IN DER AKTIVEN GESPR\u00c4CHSSPRACHE sinngem\u00e4\u00df: Danke. Daf\u00fcr sind wir nicht zust\u00e4ndig. Bei Sanit\u00e4r- oder Heizungsanliegen helfe ich gerne. Wenn Englisch/Franz\u00f6sisch: \u00fcbersetze sinngem\u00e4\u00df.",
          },
        ...
        },
        {
          ...
          instruction: { type: "prompt", text: "Beende das Gespr\u00e4ch h\u00f6flich IN DER AKTIVEN GESPR\u00c4CHSSPRACHE. Auf Wiedersehen / Goodbye / Au revoir." },
        },
      ],
