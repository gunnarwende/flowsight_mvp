...
const deGlobalPrompt = [
  ...
  "- Wenn der Anrufer Englisch, Franz\u00f6sisch oder Italienisch spricht: SOFORT das Tool 'swap_to_intl_agent' aufrufen. Kein Versuch, auf Deutsch weiterzumachen. Keine R\u00fcckfrage.",
  "",
  "THEMA",
...
const deIntakePrompt = [
  ...
  "- Wenn der Anrufer Englisch, Franz\u00f6sisch oder Italienisch spricht: SOFORT das Tool 'swap_to_intl_agent' aufrufen.",
  "- Keine Rückfrage, keine Übersetzung, kein Versuch auf Deutsch weiterzumachen.",
  "- Der Anrufer wird automatisch an einen mehrsprachigen Agenten weitergeleitet.",
  "",
...
function buildDeAgent(p) {
  ...
  const agentSwapTool = {
    ...
    description:
      "Transfer the caller to the multilingual agent when they speak English, French, or Italian. Use this tool IMMEDIATELY when non-German language is detected. Do not ask the caller first — just transfer.",
