...
const UNITS = {
  ...
  // WARM: kein HERO-04/04B (Wunde + Turn = COLD-only) und kein HERO-05 (W3 kündigt den Anruf selbst an). Ab dem Anruf (CALL) identisch.
  HERO_WARM: { title: "Hero (WARM) — voll", ids: ["HERO-W1", "HERO-W2", "HERO-W3", "CALL", ...HERO_TAIL] },
