 ...
 * neutrale Stern-Region der founder-abgenommenen Gold-Referenz (Stark) im FIXEN Fenster über
 * den Master jedes Betriebs:
 *   - Stern-Fill-Timing = Stark (millisekunde-gleich für ALLE Betriebe, Maus trifft immer).
...
// Gold-Referenz: Stark, founder-abgenommen — die Maus wurde gegen dieses Timing aufgenommen.
