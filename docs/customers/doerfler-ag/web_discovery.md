...
- The website playbook (docs/architecture/website_playbook.md) and brand system (docs/modules/marke/brand_system.md) provide a complete structural and design framework — we can build the full IA skeleton once inputs arrive.
...
| Brand System | docs/modules/marke/brand_system.md | YES | Complete design policy |
