# Founder Review: musa & partner ag
...
2. **Zefix verifiziert:** musa & partner ag (CHE-115.301.190)
3. **Google Places:** 5★ bei 9 Bewertungen
...
> **Datei:** `docs/customers/musa-partner/tenant_config.json`
...
Der Algorithmus kann die Marken-Farbe nicht sicher von einem Akzent/CTA-Ton unterscheiden — **immer kurz visuell gegen die Website abgleichen.** Firma, Prefix (`MP`), Wizard-Kategorien & Google-Rating sind via Zefix/Google zuverlässig und brauchen i.d.R. keine Korrektur.
...
| Feld | Wert | Stimmt? |
|------|------|--------|
| Firma | musa & partner ag | |
| Zefix UID | CHE-115.301.190 | |
| Google | 5★ / 9 Reviews | |
...
| Prospect E-Mail | musa-partner-ag@bluewin.ch | |
| Video Hook | Seit 1938 für Sie da. | |
...
**Greeting:** "Hallo, hier ist Lisa — die digitale Assistentin der musa & partner ag. Wie kann ich Ihnen helfen?"
...
**Termin-Frage:** "Für Termine senden Sie am besten eine kurze Nachricht an musa-partner-ag@bluewin.ch — das Team kann das dann direkt einplanen."

**Adresse:** "Sie finden uns an der Kirchstrasse 38, 8580 Amriswil."

**Stellen/Bewerbung:** "Aktuell haben wir keine offenen Stellen. Schauen Sie aber gerne auf unserer Website vorbei."

**Leistungen:** Sanitär: Sanitär, Seit 1938 bieten wir kompetente Lösungen im Sanitär- und Spenglerbereich für Sie an., Leistungen Sanitär
Beratung/Planung: Gerne erstellen wir eine kostenlose Offerte für Ihr Bauvorhaben.
...
Wenn alles stimmt:
```bash
node --env-file=src/web/.env.local scripts/_ops/pipeline_run.mjs --slug musa-partner --from provision
```
