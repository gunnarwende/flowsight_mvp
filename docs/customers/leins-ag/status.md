...
**Slug:** leins-ag
**Modus:** 2 (eigene Website: leins.ch, JS-SPA)
**ICP:** HOT (5.0★, etablierter 3-Bereiche-Betrieb)
**Stand:** 2026-06-11 — **OUTREACH versandt (live)**
**Tenant-ID:** (noch nicht provisioniert)
**Twilio-Nr:** (noch nicht zugewiesen)

## Eckdaten
- Firma: Leins AG · CHE-109.893.569
- Gewerke: **Sanitär, Heizung, Spenglerei & Blitzschutz** (3 Bereiche)
- Google: 5.0★
- Team (aus „Über uns", Beleg `docs/gtm/onboarding/Feedback/FB9.png`):
  - **Herbert Leins** — Geschäftsgründer — herbert.leins@leinsag.ch
  - **Michael Leins** — GL Sanitär & Heizung — michael.leins@leinsag.ch ← **unser Ansprechpartner**
  - **Beat Leins** — GL Spenglerei & Blitzschutz — beat.leins@leinsag.ch
  - **Tayfun Besinci** — Techniker — tayfun.besinci@leinsag.ch
