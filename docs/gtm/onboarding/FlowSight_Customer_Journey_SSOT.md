...
- **Mail-Copy-Prinzipien (aus Lessons S6–S8):** keine Demo-Sprache („durchgespielt"); Haken zum Profil matchen + nie über-claimen; am Link das Format signalisieren („Video-Einblick"). Details: `lessons_learned.md` Teil 1.
