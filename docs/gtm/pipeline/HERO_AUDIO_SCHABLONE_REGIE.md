...
| 2 | **HERO-02** „Sie nicht." | Ton **kippt** Frage→flaches Urteil, kälter/tiefer | 0,4s | **0,6s** | knapp, trocken; danach Mini-Pause (Erkenntnis) |
| 3 | **HERO-03** „…geht lautlos zum Nächsten." | **leiser**, „lautlos" fast geflüstert | 0,5s | **1,2s** | die Wunde wirken lassen; End-„n" schützen |
| 4 | **HERO-04** „Genau das hört jetzt auf." | **Kipp-Punkt**: Resignation → ruhige Entschlossenheit | **1,0s** (Atem) | 0,5s | *COLD-only*; erster Aufrichter, nicht laut |
| 5 | **HERO-05** „Ein neuer Kunde ruft an." | neutral, du trittst zurück | 0,4s | → **KLINGELN** | danach NICHT direkt Lisa |
| — | **CALL-Block** (Klingeln ~3s → Lisa+Brunner) | menschlich: klingelt, *dann* abnehmen | — | **1,0s** (Anruf beendet) | Founder schweigt; Klingel-Beat = Pflicht (s. Leppy-Auftrag) |
...
| 14 | **HERO-14** „Bei Ihnen geht ab jetzt nichts mehr verloren." | letztes Wort, **am langsamsten** | 1,0s | **2,0s** Stille | Ende NICHT abschneiden; ausklingen lassen |

## WARM-Variante (nur der Kopf ändert)
Ersetze Segmente 1–4 durch **HERO-W1 → W2 → W3**, dann direkt Segment 5 (HERO-05). **Kein HERO-04** (COLD-only).
