...
| 46.5–51 | HERO-06 | **Dashboard** · Tipp **NEU** (echte Interaktion: blauer Ring + Filter auf den einen Fall) | **DU (VO)** | „Ein vollständiger Auftrag. Angenommen, während Sie auf der Baustelle oder in einem Kundengespräch waren." |
