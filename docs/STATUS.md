...
**Datum:** 2026-04-04 (Sales Day 4: 35 PRs in 4 Tagen (#374-#408). Push-Notifications live (Notfall, Zuweisung, Bewertung). App-Badge (Android). Per-Tenant PWA. Auto-Refresh 30s. Google Review Crawl (wöchentlich). Wöchentlicher Rapport per Email. KPI Period-Filter Fix. Realistische Demo-Daten Jan-Apr 2026. Root-Cause Tenant-Cookie-Bug gefixt.)
