...
**Datum:** 2026-04-02 (Sales Day 2: 19 PRs in 2 Tagen (#374-#392). CEO-App komplett überarbeitet: Leitsystem-iframe, Quick-Actions, Tabs Live/Entwicklung/Archiv, Tenant-Switcher Cleanup, Smartphone-Preview, PWA installierbar, intelligentes Update-System mit Badge+Changelog. SMS-Spam gelöst. APP_BASE_URL zentralisiert. Voice Quality Gates.)
