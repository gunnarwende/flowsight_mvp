...
**Datum:** 2026-04-10 (Sales Day 10: 62 PRs in 10 Tagen (#374-#434). Voice Agent Gold-Standard + Leitsystem-Schablone + Demo-Audio-Pipeline + Agent Hangup Monitoring.)
...
| **Leitzentrale v3** | LIVE ✅ | /ops — FlowBar (CSS Grid, Jahres-Dropdown 2024-2026, Gold-Sterne, Quellen-Aufschlüsselung), Admin+Techniker-Ansicht, Pagination, Period-Filter, Termin-Kollisions-Warnung, Soft-Delete (Mülleimer + Wiederherstellen) |
...
|-------|------|--------|--------|
| **Dörfler AG (Oberrieden)** | doerfler-ag | voice, wizard, ops, reviews, sms | **TRIAL_PREP** — Voice Agent Gold-Standard (Lisa, Info+Intake, 18 Szenarien), 70 Demo-Cases geseedet, Leitsystem ready, Vorstellungsseite LIVE, Video-Takes in Produktion |
